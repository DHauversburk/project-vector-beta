      ...
      WHILE current_slot_start::time < p_end_time LOOP
        ...
        IF current_slot_end::time <= p_end_time THEN
            ...
            INSERT INTO appointments (
              ...
              p_is_block,
              NULL,
              COALESCE(p_notes, CASE WHEN p_is_block THEN 'SYSTEM BLOCK' ELSE NULL END)
            )
